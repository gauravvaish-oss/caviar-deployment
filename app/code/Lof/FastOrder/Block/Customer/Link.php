 ...
 */
namespace Lof\FastOrder\Block\Customer;
...
class Link extends Current
{
    ...
    protected function _toHtml()
    {
        ...
        // 4 is position in customer dashboard
        if (in_array($customerGroupId, $group) && in_array('4', $position)) {
            $router = $this->_fastOrderHelper->getFastOrderRoute();
            return '<li class="nav item"><a href="' . $this->_urlInterface->getUrl($router) . '" title="fastorder">'.__("FastOrder").'</a></li>';
        }
    }
}
