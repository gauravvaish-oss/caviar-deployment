...
<script>
                require(["jquery"], function ($) {
                    $(document).ready(function () {
                        ...
                        const $firstTab = $('#policy-tabs button.nav-link').first();
                        const $firstPane = $('.tab-pane').first();

                        $('#policy-tabs button.nav-link').removeClass('active');
                        $('.tab-pane').removeClass('active show');

                        $firstTab.addClass('active');
                        $firstPane.addClass('active show');

                        $('#policy-tabs button.nav-link').on('click', function () {
