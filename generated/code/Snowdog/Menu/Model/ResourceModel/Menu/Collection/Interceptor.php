<?php
namespace Snowdog\Menu\Model\ResourceModel\Menu\Collection;

/**
 * Interceptor class for @see \Snowdog\Menu\Model\ResourceModel\Menu\Collection
 */
class Interceptor extends \Snowdog\Menu\Model\ResourceModel\Menu\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStoresData');
        return $pluginInfo ? $this->___callPlugins('addStoresData', func_get_args(), $pluginInfo) : parent::addStoresData();
    }

    /**
     * {@inheritdoc}
     */
    public function joinStoreRelationTable() : \Snowdog\Menu\Model\ResourceModel\Menu\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinStoreRelationTable');
        return $pluginInfo ? $this->___callPlugins('joinStoreRelationTable', func_get_args(), $pluginInfo) : parent::joinStoreRelationTable();
    }
